...
/** Validadores
 *
 *  A parte de las conversiones a realizar se crean metodos
 * auxiliares para validar los datos,por ejemplo.
 * Decimal = numeros enteros
 * Binario compuesto solo por 1's y 0's
 * Octal compusto solo por numeros enteros del 0 al 7
 * Hexadecimal compuesto por numeros enteros del 0 al 9 y letras de la A a
 * la F
 *
 * @param int decimal
 * @return boolean
 ...
 *
 * @param binario, octal, hexadecimal
